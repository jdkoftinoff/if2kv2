...
public:
  ...
  BEGIN_JDK_DDX_MAP(CBlockingDlg)
    JDK_DDX_CHECK( IDC_CHECK_BLOCK_BAD_SITES, if2k_collection->additional_settings, "kernel.blocking.block.bad" )
    JDK_DDX_CHECK( IDC_CHECK_BLOCK_UNKNOWN_SITES, if2k_collection->additional_settings, "kernel.blocking.block.unknown" )
    JDK_DDX_CHECK( IDC_CHECK_BLOCK_CENSOR_CONTENT_URL, if2k_collection->additional_settings, "kernel.blocking.censor.url.content" )
    JDK_DDX_CHECK( IDC_CHECK_BLOCK_CENSOR_CONTENT_PHRASE, if2k_collection->additional_settings, "kernel.blocking.censor.phrase.content" )
    JDK_DDX_CHECK( IDC_CHECK_REDIRECT_IMAGES, if2k_collection->additional_settings, "kernel.blocking.image.redirect.enable" )
    JDK_DDX_TEXT( IDC_EDIT_MAX_MATCH_COUNT, if2k_collection->additional_settings, "kernel.blocking.content.match.threshold" )
    ...
    JDK_DDX_TEXT( IDC_EDIT_JPG_REDIRECT, if2k_collection->additional_settings, "kernel.blocking.image.redirect.jpg.url" )
    JDK_DDX_TEXT( IDC_EDIT_GIF_REDIRECT, if2k_collection->additional_settings, "kernel.blocking.image.redirect.gif.url" )
    JDK_DDX_TEXT( IDC_EDIT_PNG_REDIRECT, if2k_collection->additional_settings, "kernel.blocking.image.redirect.png.url" )
  END_JDK_DDX_MAP()
...
public:
  ...
  BEGIN_JDK_DDX_MAP(CMainDlg)
    ...
    JDK_DDX_BUF_TEXT( IDC_EDIT_BAD_URLS, m_bad_urls)
  ...
  BEGIN_DLGRESIZE_MAP(CMainDlg)
    ...
    BEGIN_DLGRESIZE_GROUP()
      DLGRESIZE_CONTROL( IDC_STATIC_BAD_URLS, DLSZ_SIZE_X  | DLSZ_REPAINT )
    ...
    BEGIN_DLGRESIZE_GROUP()
      ...
      DLGRESIZE_CONTROL( IDC_EDIT_BAD_URLS, DLSZ_SIZE_X | DLSZ_SIZE_Y  )
    END_DLGRESIZE_GROUP()
